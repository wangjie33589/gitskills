...
- (void)viewDidLoad {
    ...
    delPassWord.backgroundColor = [UIColor colorWithRed:0.06 green:0.66 blue:1 alpha:1];
    delPassWord.layer.masksToBounds = YES;
    delPassWord.layer.cornerRadius = 3;
    modifyPassWord.backgroundColor = [UIColor colorWithRed:0.06 green:0.66 blue:1 alpha:1];
    modifyPassWord.layer.masksToBounds = YES;
    modifyPassWord.layer.cornerRadius = 3;
    setPassWork.backgroundColor = [UIColor colorWithRed:0.06 green:0.66 blue:1 alpha:1];
