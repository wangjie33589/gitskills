...
-(void)APPUpdata{
    ...
    [_xmlDict removeAllObjects];
    
    NSLog(@"%@",_xmlDict);
    _xmlDict =(NSMutableDictionary*)[NSDictionary dictionaryWithXMLData:reponse];
...
//    NSString *identifierNumber = [SvUDIDTools UDID];
...
//    [[NSUserDefaults standardUserDefaults]setObject:str1 forKey:@"Code"];
//    NSLog(@"-------11111------%@",str1);
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.123.LF.LF__" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"LF__" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"LF__.sqlite"];
    NSError *error = nil;
